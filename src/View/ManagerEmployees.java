...
public class ManagerEmployees extends javax.swing.JFrame {
    ...
    public ManagerEmployees(UIController pUiController) {
        ...
        String col[] = {"Name","Lastname","Email", "EmployeeType"};
        tableModel = new DefaultTableModel(col, 0);
        
        for(Employee p: MainController.getInstance().getAdminController().getEmployees()){
            Object[] objs = {
                p.getPersonalData().getName(),
                p.getPersonalData().getLastname(),
                p.getPersonalData().getEmail(),
                p.getEmployeeType().toString()};
    ...
    private void btnAddEmpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddEmpActionPerformed
        // TODO add your handling code here:
        uiController.showWindow(ManagerRegisterEmployee.class);
    ...
    private void btnSalariesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalariesActionPerformed
        // TODO add your handling code here:
        uiController.showWindow(ManagerSalaries.class);
        this.setVisible(false);
    ...
    private void btnEditEmpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditEmpActionPerformed
        ...
        uiController.addParameters(
                MainController.getInstance().getAdminController().getEmployee(
                        (String)this.jTable1.getValueAt(this.jTable1.getSelectedRow(), 2)));
        uiController.showWindow(ManagerEditEmployee.class);
        this.setVisible(false);
